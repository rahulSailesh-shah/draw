...
class SpeechServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CleanupSession = channel.unary_unary(
                '/speech.SpeechService/CleanupSession',
                request_serializer=speech__pb2.CleanupRequest.SerializeToString,
                response_deserializer=speech__pb2.CleanupResponse.FromString,
                _registered_method=True)
...
def add_SpeechServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CleanupSession': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=speech__pb2.CleanupRequest.FromString,
                    response_serializer=speech__pb2.CleanupResponse.SerializeToString,
            ),
    }
...
class SpeechService(object):
    ...
    def StreamTranscribe(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/speech.SpeechService/StreamTranscribe',
            speech__pb2.TranscribeRequest.SerializeToString,
            speech__pb2.TranscribeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CleanupSession(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/speech.SpeechService/CleanupSession',
            speech__pb2.CleanupRequest.SerializeToString,
            speech__pb2.CleanupResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
